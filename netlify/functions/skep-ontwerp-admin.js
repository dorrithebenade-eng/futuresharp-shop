// Personeel-beskermd — voeg 'n nuwe Ontwerp/Admin-inskrywing by die "ontwerp-admin"-store.
//
...
// nie; personeel voeg dit later by (sien wysig-ontwerp-admin.js) sodra hulle
...
exports.handler = async (event, context) => {
  ...
  const ontwerp_admin_id = maak_slug(naam);
  if (!ontwerp_admin_id) {
  ...
  await store.setJSON(ontwerp_admin_id, inskrywing);
