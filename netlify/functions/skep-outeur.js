// Personeel-beskermd — voeg 'n nuwe Outeur-inskrywing by die "outeurs"-store.
//
...
// nie; personeel voeg dit later by (sien wysig-outeur.js) sodra hulle
...
exports.handler = async (event, context) => {
  ...
  await store.setJSON(outeur_id, inskrywing);
