// Personeel-beskermd — voeg 'n nuwe Spreker-inskrywing by die "sprekers"-store.
// FutureSharp Talks: gekloon uit skep-outeur.js.
//
...
// nie; personeel voeg dit later by (sien wysig-spreker.js) sodra hulle
...
// veld nie (bv. net Outeurs en Sprekers gebruik id_nommer) — onbetrokke velde bly
...
exports.handler = async (event, context) => {
  ...
  const spreker_id = maak_slug(naam);
  if (!spreker_id) {
  ...
  await store.setJSON(spreker_id, inskrywing);
