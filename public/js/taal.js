...
const WOORDEBOEK = {
  ...
  rol_spreker: { af: "Spreker", en: "Speaker" },
  ...
  fs_hulp: { af: "Kontantbasis. Finansi\u00eble jaar 1 Maart tot 28 Februarie.", en: "Cash basis. Financial year 1 March to 28 February." },
  ...
  fs_hosting_in: { af: "Hosting ingebring", en: "Hosting collected" },
  fs_hosting_oor: { af: "Hosting oor", en: "Hosting left over" },
  fs_hosting_kort: { af: "Hosting kort", en: "Hosting short" },
  fs_hosting_uit: { af: "Uitgawes gemerk gedek deur hosting", en: "Expenses marked covered by hosting" },
  fs_hosting_hulp: { af: "Uitgawes wat sonder 'n eis gedra is, is nie hierin nie.", en: "Expenses carried without a claim are not included." },
  fs_bank_kop: { af: "Bankrekonsiliasie", en: "Bank reconciliation" },
  fs_bank_leeg: { af: "Teken die balans aan op die dag voor die tydperk en op die laaste dag.", en: "Record the balance on the day before the period and on the last day." },
  fs_bank_datum: { af: "Datum", en: "Date" },
  fs_bank_bedrag: { af: "Balans", en: "Balance" },
  fs_bank_stoor: { af: "Teken aan", en: "Record" },
  fs_bank_open: { af: "Balans op", en: "Balance on" },
  fs_bank_sluit: { af: "Balans op", en: "Balance on" },
  fs_bank_beweeg: { af: "Beweging", en: "Movement" },
  fs_bank_verwag: { af: "Berekende balans", en: "Calculated balance" },
  fs_bank_verskil: { af: "Verskil", en: "Difference" },
  fs_bank_klop: { af: "Gerekonsilieer.", en: "Reconciled." },
  fs_bank_verskil_hulp: { af: "Onverklaard. Vereffenings kan oor die tydperkgrens val.", en: "Unexplained. Settlements can fall across the period boundary." },
  fs_wag_kop: { af: "Ongekategoriseerde beskrywings", en: "Uncategorised descriptions" },
  fs_wag_hulp: { af: "Geen ooreenstemmende item in die register nie.", en: "No matching item in the register." },
  ...
  pj_titel: { af: "Projekte", en: "Projects" },
  pj_nuwe_knop: { af: "+ Nuwe projek", en: "+ New project" },
  pj_soek_plek: { af: "Soek op naam, befondser of aantekening", en: "Search by name, funder or note" },
  pj_van: { af: "van", en: "of" },
  pj_een: { af: "projek", en: "project" },
  pj_meer: { af: "projekte", en: "projects" },
  pj_leeg: { af: "Die register is nog leeg. Voeg die eerste projek by.", en: "The register is empty. Add the first project." },
  pj_geen_treffer: { af: "Geen projek pas by die soektog nie.", en: "No project matches the search." },
  pj_onaktief: { af: "Onaktief", en: "Inactive" },
  pj_toets: { af: "Toets", en: "Test" },
  pj_weg: { af: "bestaan nie meer", en: "no longer exists" },
  pj_geen_befondser: { af: "Geen befondser", en: "No funder" },
  pj_aktiveer: { af: "Aktiveer", en: "Activate" },
  pj_skrap: { af: "Skrap", en: "Delete" },
  pj_haal_af: { af: "Haal af", en: "Remove" },
  pj_befondser_leeg: { af: "Geen befondser nie. Dit is geldig vir Future Sharp se eie werk.", en: "No funder. This is valid for Future Sharp's own work." },
  pj_kies_klient: { af: "Kies 'n kli\u00ebnt", en: "Choose a client" },
  pj_naam_kort: { af: "Die naam is verpligtend.", en: "The name is required." },
  pj_wysig_titel: { af: "Wysig projek", en: "Edit project" },
  pj_nuwe_titel: { af: "Nuwe projek", en: "New project" },
  pj_skrap_vra: { af: "Vee hierdie projek uit? Word dit reeds deur inskrywings gebruik, word dit gedeaktiveer in plaas van uitgevee.", en: "Delete this project? If entries already use it, it is deactivated instead of deleted." },
  pj_gedeaktiveer: { af: "Hierdie projek word deur {n} inskrywings gebruik en is gedeaktiveer. Bestaande inskrywings bly onveranderd; die projek verskyn nie meer in keuselyste nie.", en: "This project is used by {n} entries and has been deactivated. Existing entries are unchanged; the project no longer appears in selection lists." },
  pj_laai_fout: { af: "Kon nie die projekte laai nie.", en: "Could not load the projects." },
  pj_lei: { af: "'n Projek wat reeds deur inskrywings gebruik word, word gedeaktiveer, nie uitgevee nie.", en: "A project already used by entries is deactivated, not deleted." },
  pj_veld_naam: { af: "Naam", en: "Name" },
  pj_veld_befondsers: { af: "Befondsers", en: "Funders" },
  pj_opsioneel: { af: "\u2014 opsioneel", en: "\u2014 optional" },
  pj_voeg_by: { af: "Voeg by", en: "Add" },
  pj_nk_oop: { af: "+ Nuwe kli\u00ebnt", en: "+ New client" },
  pj_nk_naam: { af: "Naam van die kli\u00ebnt", en: "Client name" },
  pj_nk_soort: { af: "Soort", en: "Type" },
  pj_nk_instansie: { af: "Instansie", en: "Institution" },
  pj_nk_privaat: { af: "Privaat", en: "Private" },
  pj_nk_epos: { af: "E-pos", en: "Email" },
  pj_nk_hulp: { af: "Die ander besonderhede word later in die kli\u00ebnteregister aangevul.", en: "The remaining details are completed later in the client register." },
  pj_nk_skep: { af: "Skep en voeg by", en: "Create and add" },
  pj_veld_nota: { af: "Aantekening", en: "Note" },
  pj_kanselleer: { af: "Kanselleer", en: "Cancel" },
  pj_stoor: { af: "Stoor", en: "Save" },
  pj_naam_hulp: { af: "Begin die naam met TOETS om dit as toets te merk. Dit word dan saam met die ander toetse uitgevee.", en: "Start the name with TOETS to mark it as a test. It is then deleted with the other tests." },
  ts_titel: { af: "Skrap alle toetse", en: "Delete all tests" },
  ts_tik: { af: "Tik:", en: "Type:" },
  ts_knop: { af: "Skrap alle toetse", en: "Delete all tests" },
  ts_hulp: { af: "{p} toetsprojek(te) en {k} toetskli\u00ebnt(e): alles waarvan die naam met TOETS begin. 'n Toetskli\u00ebnt met 'n faktuur of kwotasie, of op 'n regte projek, bly staan. Tik {w} om te bevestig.", en: "{p} test project(s) and {k} test client(s): everything whose name starts with TOETS. A test client with an invoice or quotation, or on a real project, is kept. Type {w} to confirm." },
  ts_klaar: { af: "{p} projek(te) en {k} kli\u00ebnt(e) uitgevee.", en: "{p} project(s) and {k} client(s) deleted." },
  ts_bly: { af: "Bly staan:", en: "Kept:" },
  ts_fout: { af: "Kon nie uitvee nie:", en: "Could not delete:" },
  bs_pdfjs_fout: { af: "Kon nie die PDF-leser laai nie.", en: "Could not load the PDF reader." },
  bs_ketting_ok: { af: "Elke re\u00ebl se saldo klop, van {o} tot {s}.", en: "Every line's balance agrees, from {o} to {s}." },
  bs_ketting_fout: { af: "{n} re\u00ebl(s) se saldo klop nie. Die staat is nie volledig gelees nie.", en: "{n} line(s) do not agree with the balance. The statement was not read completely." },
  bs_omset_geen: { af: "Die staat dra geen omsettotaal nie.", en: "The statement carries no turnover total." },
  bs_omset: { af: "Krediete {kt} van {kf} ({kr}), debiete {dt} van {df} ({dr}).", en: "Credits {kt} of {kf} ({kr}), debits {dt} of {df} ({dr})." },
  bs_bk_geen: { af: "Geen re\u00ebls sonder beskrywing nie.", en: "No lines without a description." },
  bs_bk_ok: { af: "{n} fooire\u00ebls van {r} klop met die bankkoste-blok.", en: "{n} fee lines of {r} agree with the bank charges block." },
  bs_bk_fout: { af: "{n} re\u00ebls sonder beskrywing ({r}) klop nie met die bankkoste-blok ({b}). Hulle bly sonder kategorie.", en: "{n} lines without a description ({r}) do not agree with the bank charges block ({b}). They remain uncategorised." },
  bs_st_info: { af: "Inligting, word nie ingevoer nie", en: "Information, not imported" },
  bs_st_voorstel: { af: "Voorstel:", en: "Suggested:" },
  bs_bk_naam: { af: "Bankkoste", en: "Bank charges" },
  bs_bk_bestaan_nie: { af: "(kategorie bestaan nog nie)", en: "(category does not exist yet)" },
  bs_st_leeg: { af: "Geen beskrywing, geen kategorie", en: "No description, no category" },
  bs_st_oop: { af: "Nie toegewys nie", en: "Not allocated" },
  bs_tydperk: { af: "Tydperk", en: "Period" },
  bs_tot: { af: "tot", en: "to" },
  bs_k_ketting: { af: "Saldo-ketting", en: "Balance chain" },
  bs_k_omset: { af: "FNB se omset", en: "FNB turnover" },
  bs_k_bankkoste: { af: "Bankkoste", en: "Bank charges" },
  bs_aanvaar: { af: "Die staat is volledig gelees.", en: "The statement was read completely." },
  bs_nie_aanvaar: { af: "Die staat is nie aanvaar nie: een of meer kontroles klop nie.", en: "The statement is not accepted: one or more checks do not agree." },
  bs_tel: { af: "{n} re\u00ebls: {o} om toe te wys, {f} FNB-bankkoste, {i} inligting.", en: "{n} lines: {o} to allocate, {f} FNB bank charges, {i} information." },
  bs_h_datum: { af: "Datum", en: "Date" },
  bs_h_beskr: { af: "Beskrywing", en: "Description" },
  bs_h_in: { af: "In", en: "In" },
  bs_h_uit: { af: "Uit", en: "Out" },
  bs_h_saldo: { af: "Saldo", en: "Balance" },
  bs_h_stand: { af: "Stand", en: "Status" },
  bs_niks_gestoor: { af: "Niks is gestoor nie. Die staat is net in die blaaier gelees.", en: "Nothing has been saved. The statement was only read in the browser." },
  bs_net_pdf: { af: "Kies 'n PDF-staat.", en: "Choose a PDF statement." },
  bs_lees: { af: "Die staat word gelees \u2026", en: "Reading the statement \u2026" },
  bs_lees_fout: { af: "Kon nie die PDF lees nie.", en: "Could not read the PDF." },
  fp_nav_bankstate: { af: "Bankstate", en: "Bank statements" },
  bs_kies: { af: "Laai 'n FNB-staat op (PDF)", en: "Upload an FNB statement (PDF)" },
  bs_lei: { af: "Die PDF word op hierdie rekenaar gelees en nie opgelaai nie.", en: "The PDF is read on this computer and not uploaded." },
  bf_soort_maatskappy: { af: "Maatskappy", en: "Company" },
  bf_soort_trust: { af: "Trust", en: "Trust" },
  bf_soort_organisasie: { af: "Organisasie", en: "Organisation" },
  bf_soort_persoon: { af: "Persoon", en: "Person" },
  bf_v_reg_kort: { af: "registrasie- of ID-nommer", en: "registration or ID number" },
  bf_v_belasting_kort: { af: "belastingnommer", en: "tax number" },
  bf_v_kontak_kort: { af: "kontak", en: "contact" },
  bf_v_adres_kort: { af: "adres", en: "address" },
  bf_van: { af: "van", en: "of" },
  bf_leeg_befondser: { af: "Die register is nog leeg. Voeg die eerste befondser by.", en: "The register is empty. Add the first funder." },
  bf_leeg_skenker: { af: "Die register is nog leeg. Voeg die eerste skenker by.", en: "The register is empty. Add the first donor." },
  bf_geen_treffer: { af: "Niks pas by die soektog nie.", en: "Nothing matches the search." },
  bf_onaktief: { af: "Onaktief", en: "Inactive" },
  bf_toets: { af: "Toets", en: "Test" },
  bf_aktiveer: { af: "Aktiveer", en: "Activate" },
  bf_skrap: { af: "Skrap", en: "Delete" },
  bf_ontbreek: { af: "Vir 'n sertifikaat ontbreek:", en: "Missing for a certificate:" },
  bf_wysig_befondser: { af: "Wysig befondser", en: "Edit funder" },
  bf_wysig_skenker: { af: "Wysig skenker", en: "Edit donor" },
  bf_nuwe_befondser: { af: "Nuwe befondser", en: "New funder" },
  bf_nuwe_skenker: { af: "Nuwe skenker", en: "New donor" },
  bf_naam_kort: { af: "Die naam is verpligtend.", en: "The name is required." },
  bf_skrap_vra: { af: "Vee dit uit? Word dit reeds deur 'n toekenning of skenking gebruik, word dit gedeaktiveer in plaas van uitgevee.", en: "Delete this? If a grant or donation already uses it, it is deactivated instead of deleted." },
  bf_laai_fout: { af: "Kon nie die register laai nie.", en: "Could not load the register." },
  bso_van: { af: "van", en: "of" },
  bso_geen_treffer: { af: "Geen soort pas by die soektog nie.", en: "No type matches the search." },
  bso_leeg: { af: "Die register is nog leeg. Voeg die eerste soort by.", en: "The register is empty. Add the first type." },
  bso_onaktief: { af: "Onaktief", en: "Inactive" },
  bso_vereis_18a_kort: { af: "Vereis 18A", en: "Requires 18A" },
  bso_toets: { af: "Toets", en: "Test" },
  bso_tel: { af: "{u} om uit te reik \u00b7 {r} rekords", en: "{u} to issue \u00b7 {r} records" },
  bso_aktiveer: { af: "Aktiveer", en: "Activate" },
  bso_skrap: { af: "Skrap", en: "Delete" },
  bso_item_plek: { af: "Beskryf die item", en: "Describe the item" },
  bso_dokument: { af: "Dokument", en: "Document" },
  bso_wysig_titel: { af: "Wysig befondsingsoort", en: "Edit funding type" },
  bso_nuwe_titel: { af: "Nuwe befondsingsoort", en: "New funding type" },
  bso_naam_kort: { af: "Die naam is verpligtend.", en: "The name is required." },
  bso_skrap_vra: { af: "Vee hierdie soort uit? Word dit reeds deur 'n toekenning gebruik, word dit gedeaktiveer in plaas van uitgevee.", en: "Delete this type? If a grant already uses it, it is deactivated instead of deleted." },
  bso_laai_fout: { af: "Kon nie die befondsingsoorte laai nie.", en: "Could not load the funding types." },
  ts_hulp2: { af: "Alles waarvan die naam met TOETS begin: {p} projek(te), {k} kli\u00ebnt(e), {b} befondser(s) of skenker(s), {s} befondsingsoort(e). 'n Toetskli\u00ebnt met 'n faktuur of kwotasie, of op 'n regte projek, bly staan. Tik {w} om te bevestig.", en: "Everything whose name starts with TOETS: {p} project(s), {k} client(s), {b} funder(s) or donor(s), {s} funding type(s). A test client with an invoice or quotation, or on a real project, is kept. Type {w} to confirm." },
  ts_klaar2: { af: "Uitgevee: {p} projek(te), {k} kli\u00ebnt(e), {b} befondser(s) of skenker(s), {s} befondsingsoort(e).", en: "Deleted: {p} project(s), {k} client(s), {b} funder(s) or donor(s), {s} funding type(s)." },
  bf_titel_befondsers: { af: "Befondsers", en: "Funders" },
  bf_titel_skenkers: { af: "Skenkers", en: "Donors" },
  bso_titel: { af: "Befondsingsoorte", en: "Funding types" },
  bf_nuwe_befondser_knop: { af: "+ Nuwe befondser", en: "+ New funder" },
  bf_nuwe_skenker_knop: { af: "+ Nuwe skenker", en: "+ New donor" },
  bso_nuwe_knop: { af: "+ Nuwe soort", en: "+ New type" },
  bf_lei: { af: "Die velde wat 'n Art. 18A-sertifikaat vra, is opsioneel. Die lys wys wat ontbreek.", en: "The fields a Section 18A certificate requires are optional. The list shows what is missing." },
  bf_v_soort: { af: "Soort", en: "Type" },
  bf_v_naam: { af: "Naam", en: "Name" },
  bf_v_handelsnaam: { af: "Handelsnaam", en: "Trading name" },
  bf_opsioneel: { af: "\u2014 opsioneel", en: "\u2014 optional" },
  bf_v_reg: { af: "Registrasie- of ID-nommer", en: "Registration or ID number" },
  bf_v_belasting: { af: "Belastingnommer", en: "Tax number" },
  bf_v_kontak: { af: "Kontakpersoon", en: "Contact person" },
  bf_v_epos: { af: "E-pos", en: "Email" },
  bf_v_telefoon: { af: "Telefoon", en: "Phone" },
  bf_v_adres: { af: "Adres", en: "Address" },
  bf_v_nota: { af: "Aantekening", en: "Note" },
  bf_toets_hulp: { af: "Begin die naam met TOETS om dit as toets te merk.", en: "Start the name with TOETS to mark it as a test." },
  bf_kanselleer: { af: "Kanselleer", en: "Cancel" },
  bf_stoor: { af: "Stoor", en: "Save" },
  bso_lei: { af: "'n Toekenning kry 'n afskrif van hierdie lyste. 'n Latere wysiging verander nie 'n bestaande toekenning se lys nie.", en: "A grant receives a copy of these lists. A later change does not alter an existing grant's list." },
  bso_v_naam: { af: "Naam", en: "Name" },
  bso_v_18a: { af: "Vereis Art. 18A-goedkeuring", en: "Requires Section 18A approval" },
  bso_v_uitreik: { af: "Wat Future Sharp uitreik", en: "What Future Sharp issues" },
  bso_voeg_by: { af: "+ Voeg by", en: "+ Add" },
  bso_v_rekords: { af: "Rekords wat gehou moet word", en: "Records to be kept" },
  bso_dok_hulp: { af: "Merk Dokument waar 'n opgelaaide l\u00eaer as bewys vereis word.", en: "Tick Document where an uploaded file is required as proof." },
  bso_v_nota: { af: "Aantekening", en: "Note" },
  bf_soek_plek: { af: "Soek op naam, kontak of nommer", en: "Search by name, contact or number" },
  bso_soek_plek: { af: "Soek op naam", en: "Search by name" },
  bso_verwyder: { af: "Verwyder", en: "Remove" },
  bs_toetsstaat: { af: "Toetsstaat", en: "Test statement" },
  bs_voer_in: { af: "Voer in", en: "Import" },
  bs_invoer_lei: { af: "Re\u00ebls wat die stelsel reeds ken, word gepas; die res wag op toewysing.", en: "Lines the system already knows are matched; the rest await allocation." },
  bs_ander_rek: { af: "Hierdie staat is nie van Future Sharp se rekening nie en kan net as toetsstaat ingevoer word.", en: "This statement is not from Future Sharp's account and can only be imported as a test statement." },
  bs_t_oop: { af: "oop", en: "open" },
  bs_t_voorstel: { af: "voorgestel", en: "suggested" },
  bs_t_klaar: { af: "verklaar", en: "explained" },
  bs_geen_state: { af: "Nog geen state ingevoer nie.", en: "No statements imported yet." },
  bs_ingevoer: { af: "Ingevoerde state", en: "Imported statements" },
  bs_toets: { af: "Toets", en: "Test" },
  bs_kies_kat: { af: "Kies kategorie \u2026", en: "Choose category \u2026" },
  bs_oordrag: { af: "Oordrag tussen eie rekeninge", en: "Transfer between own accounts" },
  bs_ontdoen: { af: "Ontdoen", en: "Undo" },
  bs_st_paystack: { af: "Verklaar deur Paystack", en: "Explained by Paystack" },
  bs_st_joernaal: { af: "Reeds in die joernaal", en: "Already in the journal" },
  bs_bevestig: { af: "Bevestig", en: "Confirm" },
  bs_al_voorstelle: { af: "Bevestig al {n} voorstelle", en: "Confirm all {n} suggestions" },
  bs_maak_toe: { af: "Maak toe", en: "Close" },
  bs_net_oop: { af: "Wys net re\u00ebls wat nog verklaar moet word", en: "Show only lines still to be explained" },
  ...
  bs_nuwe_kat: { af: "+ Nuwe kategorie \u2026", en: "+ New category \u2026" },
  bs_nk_plek_in: { af: "Naam van die inkomstekategorie", en: "Name of the income category" },
  bs_nk_plek_uit: { af: "Naam van die uitgawekategorie", en: "Name of the expense category" },
  bs_nk_bo: { af: "Op die boonste vlak", en: "At the top level" },
  bs_nk_skep: { af: "Skep en wys toe", en: "Create and allocate" },
  bs_nk_kanselleer: { af: "Kanselleer", en: "Cancel" },
  bs_nk_naam_kort: { af: "Die naam is verpligtend.", en: "The name is required." },
  ms_geen_staat: { af: "Geen staat", en: "No statement" },
  ms_gedeeltelik: { af: "Gedeeltelik gedek", en: "Partly covered" },
  ms_oop: { af: "{n} re\u00ebls oop", en: "{n} lines open" },
  ms_klaar: { af: "Klaar", en: "Complete" },
  ms_h_maand: { af: "Maand", en: "Month" },
  ms_h_opening: { af: "Opening", en: "Opening" },
  ms_h_in: { af: "In", en: "In" },
  ms_h_uit: { af: "Uit", en: "Out" },
  ms_h_sluit: { af: "Sluit", en: "Closing" },
  ms_h_joernaal: { af: "Joernaal netto", en: "Journal net" },
  ms_h_verskil: { af: "Verskil", en: "Difference" },
  ms_h_stand: { af: "Stand", en: "Status" },
  ms_laai_maand: { af: "Laai maand af", en: "Download month" },
  ms_xlsx: { af: "Excel", en: "Excel" },
  ms_totaal: { af: "Boekjaar", en: "Financial year" },
  ms_verskil_nota: { af: "Verskil: die joernaal se netto min die bankre\u00ebls wat gepas of toegewys is. Paystack-geld wat oor 'n maandgrens oppad was, en betalings wat nie deur die bank geloop het nie, veroorsaak 'n verskil; die werkboek lys die joernaalinskrywings wat nie aan 'n bankre\u00ebl gekoppel is nie.", en: "Difference: the journal's net minus the bank lines that are matched or allocated. Paystack money in transit across a month end, and payments that did not pass through the bank, cause a difference; the workbook lists the journal entries not linked to a bank line." },
  ms_toetse_uit: { af: "{n} inskrywing(s) uit 'n toetsstaat is uitgesluit.", en: "{n} entry/entries from a test statement are excluded." },
  ms_laai_fout: { af: "Kon nie die maandopsomming laai nie.", en: "Could not load the monthly summary." },
  ms_aansig_reels: { af: "State en re\u00ebls", en: "Statements and lines" },
  ms_aansig_maande: { af: "Maandopsomming", en: "Monthly summary" },
  ms_boekjaar: { af: "Boekjaar", en: "Financial year" },
  ms_laai_boekjaar: { af: "Laai boekjaar af (Excel)", en: "Download financial year (Excel)" },
  ms_m1: { af: "Januarie", en: "January" },
  ms_m2: { af: "Februarie", en: "February" },
  ms_m3: { af: "Maart", en: "March" },
  ms_m4: { af: "April", en: "April" },
  ms_m5: { af: "Mei", en: "May" },
  ms_m6: { af: "Junie", en: "June" },
  ms_m7: { af: "Julie", en: "July" },
  ms_m8: { af: "Augustus", en: "August" },
  ms_m9: { af: "September", en: "September" },
  ms_m10: { af: "Oktober", en: "October" },
  ms_m11: { af: "November", en: "November" },
  ms_m12: { af: "Desember", en: "December" },
  pj_vir: { af: "vir", en: "for" },
  pj_tk_tel: { af: "{n} toekenning(s), {r} toeges\u00ea", en: "{n} grant(s), {r} committed" },
  pj_tk_geen: { af: "Nog geen toekenning nie", en: "No grant yet" },
  pj_oud_bf: { af: "Ou befondsersveld:", en: "Old funders field:" },
  pj_tk_knop: { af: "Toekennings", en: "Grants" },
  pj_vir_wie_geen: { af: "Nie vir een instansie nie", en: "Not for one institution" },
  tk_dokument: { af: "Dokument", en: "Document" },
  tk_verwyder: { af: "Verwyder", en: "Remove" },
  tk_leeg: { af: "Hierdie projek het nog geen toekenning nie.", en: "This project has no grant yet." },
  tk_tot: { af: "tot", en: "to" },
  tk_weg: { af: "bestaan nie meer", en: "no longer exists" },
  tk_met_voorwaardes: { af: "met voorwaardes", en: "with conditions" },
  tk_afgehandel: { af: "{k} van {n} afgehandel", en: "{k} of {n} completed" },
  tk_uitreik: { af: "Wat Future Sharp uitreik", en: "What Future Sharp issues" },
  tk_niks: { af: "Niks nie", en: "Nothing" },
  tk_rekords: { af: "Rekords wat gehou moet word", en: "Records to be kept" },
  tk_eie_plek: { af: "Item net vir hierdie toekenning", en: "Item for this grant only" },
  tk_eie_rekord: { af: "Rekord", en: "Record" },
  tk_eie_uitreik: { af: "Uitreik", en: "Issue" },
  tk_voeg_by: { af: "Voeg by", en: "Add" },
  tk_wysig: { af: "Wysig bedrag en tydperk", en: "Edit amount and period" },
  tk_skrap: { af: "Skrap toekenning", en: "Delete grant" },
  tk_skrap_vra: { af: "Vee hierdie toekenning en sy kontrolelys uit?", en: "Delete this grant and its checklist?" },
  tk_kies_bf: { af: "Kies 'n befondser", en: "Choose a funder" },
  tk_kies_soort: { af: "Kies die soort befondsing", en: "Choose the funding type" },
  tk_vereis_18a: { af: "vereis 18A-goedkeuring", en: "requires 18A approval" },
  tk_stoor: { af: "Stoor", en: "Save" },
  tk_skep: { af: "Skep toekenning", en: "Create grant" },
  tk_laai_fout: { af: "Kon nie die toekennings laai nie.", en: "Could not load the grants." },
  tk_titel: { af: "Toekennings", en: "Grants" },
  pj_veld_soort: { af: "Soort projek", en: "Project type" },
  pj_soort_hulp: { af: "Kies een wat reeds gebruik is, of tik 'n nuwe soort.", en: "Choose one already in use, or type a new type." },
  pj_veld_vir_wie: { af: "Vir wie", en: "For whom" },
  pj_vir_wie_hulp: { af: "Die skool of instansie waarvoor die projek is, uit die kli\u00ebnteregister. Die befondsing kom by die toekennings.", en: "The school or institution the project is for, from the client register. The funding goes under the grants." },
  tk_lei: { af: "Elke toekenning kry by die skep 'n afskrif van die befondsingsoort se kontrolelys. Merk items af soos hulle afgehandel word.", en: "Each grant receives a copy of the funding type's checklist when it is created. Tick items off as they are completed." },
  tk_v_befondser: { af: "Befondser", en: "Funder" },
  tk_v_soort: { af: "Soort befondsing", en: "Funding type" },
  tk_v_bedrag: { af: "Bedrag toeges\u00ea", en: "Amount committed" },
  tk_v_voorwaardes: { af: "Met voorwaardes (net vir hierdie doel)", en: "With conditions (for this purpose only)" },
  tk_v_van: { af: "Van", en: "From" },
  tk_v_tot: { af: "Tot", en: "To" },
  tk_v_nota: { af: "Aantekening", en: "Note" },
  tk_v_hulp: { af: "Die befondser en die soort bepaal die kontrolelys en kan n\u00e1 die skep nie verander word nie.", en: "The funder and the type determine the checklist and cannot be changed after creation." },
  tk_toe: { af: "Maak toe", en: "Close" },
  tk_nuut: { af: "+ Nuwe toekenning", en: "+ New grant" },
  pj_soort_plek: { af: "Byvoorbeeld Skool of Geleentheid", en: "For example School or Event" },
  pj_deel2_kort: { af: "Deel II", en: "Part II" },
  pj_baat_tel: { af: "{n} deelnemers", en: "{n} participants" },
  pj_baat_pct: { af: ", {p}% swart", en: ", {p}% black" },
  pj_veld_pba: { af: "Openbare-voordeel-aktiwiteit (PBA)", en: "Public benefit activity (PBA)" },
  pj_deel2: { af: "Val onder Deel II (18A-kwalifiserend)", en: "Falls under Part II (18A-qualifying)" },
  pj_pba_hulp: { af: "Die aktiwiteit in die Negende Bylae waaronder die projek val. Bevestig met die rekenmeester of dit onder Deel II val.", en: "The activity in the Ninth Schedule the project falls under. Confirm with the accountant whether it falls under Part II." },
  pj_veld_baat: { af: "Wie baat vind", en: "Who benefits" },
  pj_baat_getal: { af: "Getal deelnemers", en: "Number of participants" },
  pj_baat_swart: { af: "Persentasie swart", en: "Percentage black" },
  pj_baat_hulp: { af: "Totale, nie name nie. B-BBEE-befondsers vra dat minstens 75% van die deelnemers swart is.", en: "Totals, not names. B-BBEE funders ask that at least 75% of participants are black." },
  pj_pba_plek: { af: "Byvoorbeeld Onderwys en ontwikkeling", en: "For example Education and development" },
  pj_baat_plek: { af: "Byvoorbeeld Graad 10-leerders", en: "For example Grade 10 learners" },
  tk_dok_af: { af: "Laai af", en: "Download" },
  tk_dok_ontbreek: { af: "Dokument ontbreek", en: "Document missing" },
  tk_laai_op: { af: "Laai op", en: "Upload" },
  tk_aanbod: { af: "Die soort het sedert die skep {n} nuwe item(s) gekry: {l}.", en: "The type has received {n} new item(s) since creation: {l}." },
  tk_neem_oor: { af: "Voeg by", en: "Add" },
  tk_dok_lees: { af: "Kon nie die l\u00eaer lees nie.", en: "Could not read the file." },
  tk_dok_groot: { af: "Die l\u00eaer is groter as 4 MB. Maak dit eers kleiner.", en: "The file is larger than 4 MB. Make it smaller first." },
  tk_dok_skrap_vra: { af: "Vee hierdie bewysstuk uit?", en: "Delete this document?" },
  tk_ontvang: { af: "Ontvang", en: "Received" },
  tk_bestee: { af: "Bestee", en: "Spent" },
  tk_koppel_gekose: { af: "Koppel gekose ({n})", en: "Link selected ({n})" },
  tk_ontkoppel: { af: "Ontkoppel", en: "Unlink" },
  tk_geen_kp: { af: "Nog geen inskrywing gekoppel nie.", en: "No entry linked yet." },
  tk_kies_soek: { af: "Soek in die joernaal", en: "Search the journal" },
  tk_elders: { af: "by 'n ander toekenning", en: "on another grant" },
  tk_kies_leeg: { af: "Geen inskrywings in hierdie tydperk nie.", en: "No entries in this period." },
  tk_kp_kop: { af: "Gekoppelde inskrywings", en: "Linked entries" },
  tk_koppel: { af: "+ Koppel inskrywings uit die joernaal", en: "+ Link entries from the journal" },
  ...
  kt_lei: {
    af: "'n Kategorie word nie uitgevee nie. Plaas dit onder die korrekte kategorie; bestaande state bly onveranderd.",
    en: "A category is not deleted. Place it under the correct category; existing statements remain unchanged.",
  },
  ...
  kt_onder_hulp: {
    af: "'n Kategorie kan inskrywings dra en terselfdertyd subkategorie\u00eb h\u00ea.",
    en: "A category can carry entries and have subcategories at the same time.",
  },
  kt_hosting: { af: "Word deur hosting gedek", en: "Covered by hosting" },
  kt_hosting_kort: { af: "Hosting", en: "Hosting" },
  kt_hosting_hulp: {
    af: "Die staat vergelyk die totaal van gemerkte kategorie\u00eb met die hosting wat ingevorder is.",
    en: "The statement compares the total of marked categories with the hosting collected.",
  },
  kt_veld_nota: { af: "Aantekening", en: "Note" },
  kt_opsioneel: { af: "\u2014 opsioneel", en: "\u2014 optional" },
  kt_nota_hulp: {
    af: "Verskyn langs die kategorie in die register.",
    en: "Appears beside the category in the register.",
  },
  kt_vas: { af: "Stelsel", en: "System" },
  kt_toets: { af: "Toets", en: "Test" },
  kt_vas_hulp: {
    af: "Hierdie kategorie word deur die stelsel onderhou. Die naam en die klassifikasie is vas; slegs die hoofkategorie kan verander word.",
    en: "This category is maintained by the system. The name and the classification are fixed; only the main category can be changed.",
  },
  kt_naam_kort: { af: "Die naam is verpligtend.", en: "The name is required." },
  kt_skrap: { af: "Skrap", en: "Delete" },
  kt_skrap_vra: {
    af: "Vee hierdie kategorie uit? Word dit reeds deur inskrywings gebruik, word dit gedeaktiveer in plaas van uitgevee.",
    en: "Delete this category? If it is already used by entries, it is deactivated instead of deleted.",
  },
  // DIE DEAKTIVERING (6 September 2026). 'n Kategorie wat inskrywings dra,
  // word nie uitgevee nie -- 'n uitgereikte faktuur en 'n ou staat sou dan na
  // niks wys. {n} word deur die skerm vervang.
  kt_onaktief: { af: "Onaktief", en: "Inactive" },
  kt_aktiveer: { af: "Aktiveer", en: "Activate" },
  kt_gedeaktiveer: {
    af: "Hierdie kategorie word deur {n} inskrywings gebruik en is gedeaktiveer. Bestaande inskrywings en state bly onveranderd; die kategorie verskyn nie meer in keuselyste nie.",
    en: "This category is used by {n} entries and has been deactivated. Existing entries and statements remain unchanged; the category no longer appears in selection lists.",
  },
